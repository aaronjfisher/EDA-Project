...
function carry_true_answer($questionType, $questionVersion){
        $answerFile = '../pGraphs/MainQuestions/Q'.$questionType.'/Answer/Version-'.$questionVersion.'.txt';
...
function print_Q1($qVersion, $qOrA, $trueAnswer, $guess){
     $PValueGraph = "../pGraphs/MainQuestions/Q1/QFigure"; 
     ...
     print '</div>';
     print '<br />';
     print '<form action="DiscreteQuestions.php" method = "post">';
     if ($qOrA == "q") {
...
function print_Q2($qVersion, $graphOrder, $qOrA, $guess){
  $PValueGraph = "../pGraphs/MainQuestions/Q2/Figure";
  $PValueVersion = $qVersion;
  $pvalueFile = "../pGraphs/MainQuestions/Q2/PValues/Version-".$qVersion.".txt";
  ...
  for($i = 0; $i < 4; ++$i){
    ...
    print '<div class = "graph">';
    print '<IMG src = "../pGraphs/MainQuestions/Q2/Figure';
    print $graphOrder[$i];
    print '/Version-';
    print $qVersion;
    print '.png" width = "250" height = "260">';
...
function print_Q3($qVersion, $graphOrder, $qOrA, $guess){
  $PValueGraph = "../pGraphs/MainQuestions/Q3/Figure";
  $PValueVersion = $qVersion;
  $pvalueFile = "../pGraphs/MainQuestions/Q3/PValues/Version-".$qVersion.".txt";
  $pvalues = file($pvalueFile);
  ...
  for($i = 0; $i < 2; ++$i){
    print '<div class = "figure">';
    print '<div class = "graph">';
    print '<IMG src = "../pGraphs/MainQuestions/Q3/Figure';
    print $graphOrder[$i];
    print '/Version-';
    print $qVersion;
    print '.png" width = "250" height = "260">';
...
function print_Q4($qVersion, $qOrA, $trueAnswer, $guess){
     $PValueGraph = "../pGraphs/MainQuestions/Q4/QFigure"; 
     $PValueVersion = $qVersion;
...
function print_Q5($qVersion, $qOrA, $trueAnswer, $guess){
     $PValueGraph = "../pGraphs/MainQuestions/Q5/QFigure"; 
     $PValueVersion = $qVersion;
